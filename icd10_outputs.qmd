...
```{r, codelist top 10 trend over time, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.height=8, out.height='100%', fig.width=10, out.width = '100%', fig.cap = "Figure 3 Top 10 most frequent ICD-10 codes recorded for the pregnancy ICD-10 codelist in financial year 2023-24", fig.topcaption=TRUE}
