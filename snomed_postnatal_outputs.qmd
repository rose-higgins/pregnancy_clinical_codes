---
title: SNOMED post-natal Codelist
output:
  html_document:
  theme: journal
github_document:
...
<!-- # ###################################################################################################################
# Script creating plots of key outputs for analysing SNOMED post-natal codelist trends over time and codelist changes over time
#
...
# Input directory ----
input_dir_os <- here("snomed_postnatal_outputs")

# Output directory ----
output_dir_rmd <- here("snomed_postnatal_outputs")
...
```{r, coverage plot, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=10, out.width = '100%', fig.cap = "Figure 1 Total national SNOMED codes frequency by financial year", fig.topcaption=TRUE}
...
```{r, codelist summary trend, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=10, out.width = '100%', fig.cap = "Figure 2 Total national SNOMED code frequency for the post-natal SNOMED codelist by financial year", fig.topcaption=TRUE}
########################################
# Codelist specific outputs

# Import the codelist
pregnancy_codelist <- get_codelist("user/VickiPalin/pregnancy_postnatal_8wk_snomed_reviewed/021cbb8d/")
...
ggsave(here::here(output_dir_rmd,"figures","snomed_postnatal_codelist_summary_plot.png"), del_codelist_data_summary_plot)

include_graphics(fs::path(output_dir_rmd,"figures","snomed_postnatal_codelist_summary_plot.png"))
```
...
del_top_10_codes_table %>%
  ...
  save_kable(file = "snomed_postnatal_outputs/tables/top_10_snomed_postnatal_codes_table.html"
              , zoom = 1.5)
webshot2::webshot("snomed_postnatal_outputs/tables/top_10_snomed_postnatal_codes_table.html", "snomed_postnatal_outputs/tables/top_10_snomed_postnatal_codes_table.png")

# include_graphics(fs::path(output_dir_rmd,"tables","top_10_snomed_postnatal_codes_table.png"))
```
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=10, out.width = '100%', fig.cap = "Table 1 Top 10 most frequent SNOMED codes recorded for the post-natal SNOMED codelist in financial year 2023-24", fig.topcaption=TRUE}
include_graphics(fs::path(output_dir_rmd,"tables","top_10_snomed_postnatal_codes_table.png"))
```

```{r, codelist top 10 trend over time, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.height=8, out.height='100%', fig.width=10, out.width = '100%', fig.cap = "Figure 3 SNOMED code usage trends for the top 10 most frequent SNOMED codes recorded annually for the SNOMED post-natal codelist", fig.topcaption=TRUE}
...
write.csv(del_top_10_codes_each_year, file ="snomed_postnatal_outputs/tables/top_10_snomed_postnatal_codes_each_year.csv")    
...
ggsave(here::here(output_dir_rmd,"figures","top_10_snomed_postnatal_codes_all_years_plot.png"), del_top_10_codes_all_years_plot, width = 30, units = "cm")

include_graphics(fs::path(output_dir_rmd,"figures","top_10_snomed_postnatal_codes_all_years_plot.png"))
```