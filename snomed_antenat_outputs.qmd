---
title: SNOMED Antenatal Codelist
output:
  html_document:
  theme: journal
github_document:
...
```{r, codelist top 10 trend over time, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.height=8, out.height='100%', fig.width=10, out.width = '100%', fig.cap = "Figure 3 SNOMED code usage trends for the top 10 most frequent SNOMED codes recorded annually for the SNOMED antenatal codelist", fig.topcaption=TRUE}
